...
function [ zig_zag_out ] = zig_zag_cod( input_matrix, n)
...
for i=s-2:-1:-(s-1) % for each diagonal
    ...
    zig_zag_out = cat(2, zig_zag_out, d);
end
...
zig_zag_out = reshape(zig_zag_out, n, n); % reshape to fit input size
end
